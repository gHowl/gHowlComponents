...
namespace gHowl.KML
{
    public class KMLStyleComponent_OBSOLETE : GH_Component
    {
        public KMLStyleComponent_OBSOLETE() : base("KML Style","S","KML Object Attributes: Fill Color, Line Color, Line Width","gHowl","KML") { }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            KMLStyleType_OBSOLETE style = new KMLStyleType_OBSOLETE(fc,lc,w);
            DA.SetData(0, style);
        }
