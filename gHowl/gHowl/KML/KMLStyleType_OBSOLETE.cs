...
namespace gHowl.KML
{
    public class KMLStyleType_OBSOLETE : IGH_Goo, GH_ISerializable
    {
        //Fields
        ...
        public KMLStyleType_OBSOLETE(Color fillC, Color lineC, double lineW)
        {
        ...
        // Copy Constructor
        public KMLStyleType_OBSOLETE(KMLStyleType_OBSOLETE KMLStyleSource)
        {
